    ...
    <header className="fixed inset-x-0 top-4 z-50 px-4">
      <div className="mx-auto flex w-fit items-center gap-20 rounded-full border border-[#0e1020]/10 bg-[#efdfe7] px-2 py-2 text-[#0e1020] shadow-[0_10px_40px_-10px_rgba(0,0,0,0.2)] backdrop-blur-xl">
        ...
        <button
          ...
          aria-expanded={open}
          className="flex items-center rounded-full border border-[#6f64ff] bg-transparent px-7 py-3 text-[1.225rem] font-semibold uppercase tracking-widest text-[#6f64ff] transition hover:bg-[#6f64ff] hover:text-white"
        >
